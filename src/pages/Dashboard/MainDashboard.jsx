...
const MainDashboard = () => {
  ...
  const topStats = [
    { label: "On Boarded Users", value: "5", color: "bg-orange-500", icon: <Users size={16} /> },
    { label: "Mapped Users", value: "2", color: "bg-orange-400", icon: <CheckCircle2 size={16} /> },
    { label: "Projects", value: "3", color: "bg-orange-300", icon: <LayoutGrid size={16} /> },
    { label: "Organizations", value: "2", color: "bg-orange-200", icon: <Network size={16} /> },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-2xl p-8 border border-orange-100 shadow-sm flex items-center justify-between relative overflow-hidden">
          <div className="z-10 max-w-md">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-3">MNR AT Dashboard</h2>
          ...
          <div className="w-32 h-32 bg-orange-50 rounded-2xl flex items-center justify-center p-4">
            <div className="text-orange-600 font-black text-2xl italic tracking-tighter">MNR<span className="text-orange-400">AT</span></div>
          </div>
        </div>
      ...
      {[40, 65, 30, 85, 45, 90, 50, 75].map((h, i) => (
        <div key={i} className="flex flex-col items-center gap-2 w-full group">
          <div className="flex gap-1.5 w-full justify-center items-end h-full">
            <div className="w-2.5 bg-orange-600 rounded-t-sm" style={{ height: `${h}%`, minHeight: '4px' }}></div>
            <div className="w-2.5 bg-orange-400 rounded-t-sm" style={{ height: `${h * 0.7}%`, minHeight: '4px' }}></div>
            <div className="w-2.5 bg-slate-400 rounded-t-sm" style={{ height: `${h * 0.4}%`, minHeight: '4px' }}></div>
          </div>
  ...
  <div className="bg-white rounded-2xl p-6 shadow-sm border border-orange-100 flex flex-col items-center">
    ...
    <div className="relative w-44 h-44">
      <svg viewBox="0 0 36 36" className="w-full h-full transform -rotate-90">
        ...
        <circle cx="18" cy="18" r="16" fill="none" className="stroke-orange-600" strokeWidth="4" strokeDasharray="45 100"></circle>
        <circle cx="18" cy="18" r="16" fill="none" className="stroke-orange-400" strokeWidth="4" strokeDasharray="30 100" strokeDashoffset="-45"></circle>
        <circle cx="18" cy="18" r="16" fill="none" className="stroke-orange-200" strokeWidth="4" strokeDasharray="7 100" strokeDashoffset="-75"></circle>
      </svg>
