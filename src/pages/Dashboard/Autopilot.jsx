    ...
    <div className="p-6 max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-800">
          <span className="text-blue-900 text-xl font-bold">MNR</span>{" "}
          <span className="text-orange-500 text-2xl font-bold">AT</span> Auto
          Pilot
        </h1>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-slate-400">
                How deep should the crawler navigate (1-10)
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-[10px] text-slate-400">
                Maximum number of pages to crawl and test (5-100)
              </p>
            </div>
            ...
            <div className="space-y-4 pt-4">
              <ToggleSwitch
                ...
                sub="Automatically Generate test cases using AI"
                defaultChecked
              />
              <ToggleSwitch
                label="Execute Tests"
                sub="Automatically Execute generated test cases"
                defaultChecked
              />
              <ToggleSwitch
                label="Self-Healing"
                sub="Enable AI Powered self-healing for test automation"
                defaultChecked
              />
            </div>
    ...
    {metrics && (
      <div className="grid grid-cols-4 gap-2 text-center">
        {metrics.map((m, i) => (
          <div key={i}>
            <p
              className={`text-lg font-bold ${m.val > 0 ? "text-teal-500" : "text-blue-400"}`}
            >
              {m.val}
            </p>
